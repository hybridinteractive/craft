...
function loadElements() {
    ...
    $.ajax({
        type: "GET",
        url: "https://www.accessfund.org/external/top-nav-hk",
        dataType:'html',
    ...
    $.ajax({
        type: "GET",
        url: "https://www.accessfund.org/external/footer-hk",
        dataType:'html',
        success: function(response) {
...
var $otherButton = $('div[data-giving-frequency="One Payment"]');
...
function clickAndHideOtherButton() {
    if ($otherButton.length) {
        $otherButton.trigger('click');
        $otherButton.closest('.rc-toggle-primary-container').hide();
    }
}
